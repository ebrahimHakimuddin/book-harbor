...
/** A newer release than the installed one, or null when up to date. Throws when GitHub can't be reached. */
...
fun latestRelease(): Release {
    ...
    try {
        ...
        return Release(json.getString("tag_name").removePrefix("v"), json.getString("html_url"))
    } finally {
